...
<div class="container">
  <div class="col col-6 p-5 bg-white mx-auto" style="border-radius: 28px !important; border: 2px solid blue !important">
    <div class="form_register">
      ...
      <form:form method="POST" action="${action}" modelAttribute="user" class="form" id="form-2"
        ...
        <div class="form-group">
          ...
          <input id="phoneNumber" name="phoneNumber" path="text" type="phoneNumber" placeholder="Nhập số điện thoại"
            class="form-control">
          <span class="form-message"></span>
        </div>
